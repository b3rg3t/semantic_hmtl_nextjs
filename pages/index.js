...
export function Image({ src, width, height, className, alt }) {
  const isAmp = useAmp()
  return isAmp ? (
    <amp-img className={className} src={src} width="400" height="270" alt={alt} layout="fixed"></amp-img>
  ) : (
  ...
  return (
    <>
      <Layout title="Home Page" token={props.token}>
        ...
        <main>
          <div className="index">
          <Image className="catimg" src="../images/cat1.jpg" width="100%" height="auto" alt="cat1 behind fence" />
